...
export class UpdateSessionEntity1707570031119 implements MigrationInterface {
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "session" ADD CONSTRAINT "FK_8e05f295cd772ec97ef56642192" FOREIGN KEY ("user") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    }
